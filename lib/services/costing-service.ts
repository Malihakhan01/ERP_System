...
// Supabase Database Service Layer for FactoryOS Garment Pre-Costing & BOM Estimation
// Primary source of truth: PostgreSQL `cost_estimates` table with offline cache fallback.
