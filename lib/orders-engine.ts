...
export const INITIAL_ORDERS: OrderRecord[] = [
  {
    ...
    description: "Export quality 380 GSM brushed fleece hooded sweatshirt with double-layered hood and front kangaroo pocket.",
    fabric: "380 GSM Heavy Fleece (80% Cotton / 20% Polyester)",
    gsm: "380 GSM",
    color: "Jet Black / Forest Green",
    sizeRange: "S, M, L, XL, XXL",
    customizationNotes: "Embroidered chest crest (8,000 stitches) + high-density silicone cuff print.",
    quantity: 500,
    unitPrice: 21.09,
    subtotal: 10545.0,
    discount: 0,
    ...
    incoterms: "FOB Sialkot Dry Port",
    shippingMethod: "Sea Freight (FCL)",
    destinationPort: "Port of Felixstowe Logistics Hub",
    buyerPoRef: "PO-UK-98210",
    ...
    timeline: [
      {
        ...
        description: "Official purchase order booked for 500 pcs @ Rs 21.09/pc.",
      ...
      },
      {
        ...
        description: "Pre-costing BOM approved with 25% gross margin (Rs 15.82 cost / Rs 21.09 FOB).",
      ...
      },
      {
        ...
        description: "30% advance TT received (Rs 3,163.50) against INV-2026-001.",
    ...
    timeline: [
      {
        id: "evt_ord_21",
        title: "Order Contract Created",
        description: "1,200 pcs booked @ Rs 10.71/pc under CIF Gothenburg terms.",
