...
CREATE TABLE `employees` (
    ...
    `notes` TEXT NULL,
    `password_hash` VARCHAR(255) NULL DEFAULT 'emp12345',
    `is_portal_active` TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE `qa_inspections` (
    ...
    `inspection_type` VARCHAR(100) NOT NULL DEFAULT 'End-Line Final Audit',
